...
# Create /home/ubuntu directory if it does not exist 
    ...
    wget "https://ramratan-bucket-2510.s3.amazonaws.com/jenkins.pem?AWSAccessKeyId=AKIAZ3MGMYHMT6M3VUVM&Signature=Ci4cGtZf45mWEDajrIfPn0uJYNU%3D&Expires=1734609610" -O /home/ubuntu/jenkins.pem
...
# Fetch the private IP of the MySQL instance dynamically
    MYSQL_IP=$(aws ec2 describe-instances --instance-ids 
${aws_instance.mysql_instance.id} --query "Reservations[].Instances[].PrivateIpAddress" --output text)
